...
void Save_Analyzable_Tree() {
    ...
    TFile* outputFile = new TFile("Analyzable_Tree.root", "RECREATE"); //numuCC
    ...
    Spectrum spec_TransMomFraction_optimal("Transverse Mom. Fraction", binstheta, loader, TransMomFraction, kCosmicCut && kHas1Prongs && kIsNumu && numurecoCut && nonegative5Cut && kdist_bt_vtx_recn_truthCut); // optimal
    ...
    // Spectrum spec_kResolutionNumuE("ResolutionNumuEnergy", binsresE, loader, kResolutionNumuE, kCosmicCut && kHas1Prongs && kIsNumu && numurecoCut && kdist_bt_vtx_recn_truthCut); //kdis_bt_vtx_recn_truthCut is truth cut
    ...
    // Spectrum spec_TransMomFraction_vs_truth(loader, TransMomFraction_vs_truth, kCosmicCut && kHas1Prongs && kIsNumu && numurecoCut && nonegative5Cut && kdist_bt_vtx_recn_truthCut, kNoShift);
